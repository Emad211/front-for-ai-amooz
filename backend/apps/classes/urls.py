...
from .views_exercises import (
    ...
    ExerciseCancelView,
    ExercisePublishView,
    ExerciseReferenceIngestApplyView,
    ExerciseReferenceIngestPreviewView,
    ...
    StudentExerciseAnswerSourceStatusView,
    ...
    StudentExerciseAnswerAssetContentView,
...
from .views import (
    ...
    ExamPrepVisualAssetView,
    ExamPrepVisualAssetContentView,
    ExamPrepExtractionReviewConfirmView,
    ExamPrepExtractionUnitRetryView,
    ExamPrepExtractionUnitSourceView,
...
urlpatterns = [
    ...
    path('exercises/<int:exercise_id>/cancel/', ExerciseCancelView.as_view(), name='exercise_cancel'),
    path('exercises/<int:exercise_id>/publish/', ExercisePublishView.as_view(), name='exercise_publish'),
    path('exercises/<int:exercise_id>/reference-ingest/preview/', ExerciseReferenceIngestPreviewView.as_view(), name='exercise_reference_ingest_preview'),
    path('exercises/<int:exercise_id>/reference-ingest/apply/', ExerciseReferenceIngestApplyView.as_view(), name='exercise_reference_ingest_apply'),
    ...
    path('student/courses/<int:session_id>/exercises/<int:exercise_id>/answer-sources/status/', StudentExerciseAnswerSourceStatusView.as_view(), name='student_exercise_answer_source_status'),
    ...
    path('exercise-answer-assets/<int:asset_id>/content/', StudentExerciseAnswerAssetContentView.as_view(), name='student_exercise_answer_asset_content'),
    ...
    path('exam-prep-sessions/<int:session_id>/extraction-units/<int:unit_id>/source/', ExamPrepExtractionUnitSourceView.as_view(), name='exam_prep_extraction_unit_source'),
