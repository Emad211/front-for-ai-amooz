...
LIVE_KEYS = {
    ...
    "exam_prep_page_extraction": ["default"],
    "exam_prep_question_inventory": ["default"],
    "exam_prep_answer_inventory": ["default"],
    "exam_prep_question_audit": ["default"],
    "exam_prep_question_repair": ["default"],
    "exam_prep_visual_detection": ["default"],
    "exam_prep_visual_generation": ["default"],
    "exam_prep_visual_verification": ["default"],
    "exam_prep_v4_page_classification": ["default"],
    "exam_prep_v4_block_detection": ["default"],
    "exam_prep_v4_question_extraction": ["default"],
    "exam_prep_v4_answer_solution_extraction": ["default"],
