...
class StudyGroup(models.Model):
    ...
    belong to it via :class:`StudyGroupMembership`. Courses
    (``classes.ClassCreationSession``) — and therefore their AI cost — roll up to
    the group, so a group is the unit org analytics & cost are grouped by.
    """
