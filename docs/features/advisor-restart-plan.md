...
وضعیت: **پیش‌نویس برای اجرا** · منبع: PDF «ری‌استارت — مجلۀ مشاوره و برنامه‌ریزی» (۴۴ صفحه، ماه مهر) + وضعیت لندشدهٔ S1–S9 · پیش‌نیاز: `docs/features/advisor-mvp.md` (تنها منبع حقیقت MVP)
