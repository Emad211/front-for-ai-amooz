	...
	return (
		<div className="space-y-6 max-w-4xl mx-auto text-right">
			<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
				<div>
					<h1 className="text-2xl md:text-3xl font-black text-foreground">تنظیمات معلم</h1>
					<p className="text-muted-foreground text-sm mt-1">پروفایل، امنیت و اعلان‌های پنل معلم</p>
				</div>
			...
			<Tabs defaultValue="profile" className="space-y-6">
				...
				<TabsContent value="profile">
					<ProfileTab useSettings={useTeacherSettings} />
				</TabsContent>

				<TabsContent value="security">
					<SecurityTab useSettings={useTeacherSettings} />
				</TabsContent>

				<TabsContent value="notifications">
					<NotificationsTab useSettings={useTeacherSettings} />
				</TabsContent>
