...
export function LandingFooter() {
  ...
  return (
    <footer className="landing-section-shell h-[787px] px-2 pb-2 pt-10 sm:px-4 sm:py-10 lg:h-[497px] lg:px-8">
      <div className="landing-panel landing-dot-pattern mx-auto flex h-[739px] w-full max-w-[1856px] flex-col justify-between overflow-hidden px-5 py-10 sm:px-10 lg:h-[417px] lg:px-24">
