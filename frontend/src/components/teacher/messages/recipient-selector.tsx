        ...
        >
          ...
          >
            ...
            <div className="flex-1">
              <Label htmlFor="all" className="cursor-pointer font-bold block">همه دانش‌آموزان من</Label>
              <p className="text-[10px] text-muted-foreground">ارسال به تمام دانش‌آموزان کلاس‌های شما</p>
            </div>
          ...
          >
            ...
            <div className="flex-1">
              <Label htmlFor="specific" className="cursor-pointer font-bold block">انتخاب دانش‌آموزان خاص</Label>
              <p className="text-[10px] text-muted-foreground">انتخاب از لیست دانش‌آموزان من</p>
            </div>
